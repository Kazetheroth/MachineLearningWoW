...
//    public static extern void DeleteLinearModel(System.IntPtr model);
    ...
    public static extern System.IntPtr trainMLPModel(int[] neuronsPerLayer, int nplSize, double[] X, double[] Y, int sampleSize, int epochs, double learningRate, bool isClassification, double[] outputToTest, int outputSize);
    ...
    public static extern System.IntPtr trainRBFModel(double[] X, int nbImages, int nbPixelInImage, double[] Y, int nbCentroid, int nbClasses, int maxKmeans, double[] testX, double[] testY, float gamma, int outputSize);
    ...
    [DllImport("MlDll", EntryPoint = "train_rbf_model_get_weights")]
    public static extern System.IntPtr trainRbfModelGetWeights(double[] X, int nbImages, int nbPixelInImage, double[] Y, int nbCentroid, int nbClasses, int maxKmeans, float gamma, double[] centroids);
